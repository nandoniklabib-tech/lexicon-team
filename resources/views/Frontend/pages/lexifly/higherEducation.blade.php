...
@section('content')
    ...
    <section class="main-content-background">
      <div class="container py-3 py-md-5">
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-banner" style="background-image: url('{{asset("images/settings/".$setting->higher_education_image)}}');">
              <h3 class="text-center text-md-start pt-5 ps-0 ps-md-5">LexiFly</h3>
              <p class="text-center text-white text-md-start pt-2 ps-0 ps-md-5">Choose The Country Higher Education</p>
            </div>
          </div>
        </div>
        ...
        <div class="row mt-5 mb-3">
          <div class="col-12">
            <h3 class="lexicon-heading">CHOOSE YOUR COUNTRY</h3>
          </div>
        </div>
        ...
        <div class="row justify-content-center mt-5">
          ...
          <div class="col-md-3 mb-5">
            <a href="#" class="text-center text-dark" data-bs-toggle="modal" data-bs-target="#higher{{$data->id}}">
                <div class="lexifly-country-image mb-3" style="background-image: url('{{asset("images/lexiflycountries/".$data->image)}}');"></div>
                <h5>{{$data->name}}</h5>
            </a>
          </div>
        <!-- higher{{$data->id}} -->
        <div class="modal fade" id="higher{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
