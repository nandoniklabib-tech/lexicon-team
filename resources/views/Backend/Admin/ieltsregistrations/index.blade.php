    ...
    <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form action="{{url('ieltsregistrations')}}" method="post" enctype="multipart/form-data" > @csrf
        ...
        <div class="col-12">
            ...
            <div class="table-responsive">
                <table class="table table-dark table-responsive table-hover table-striped">
                  ...
                  <tbody>
                    @foreach($ieltsregistrations as $data)
                    <tr>
                      ...
                      <td class="text-end text-nowrap">
                          <a href="{{url('ieltsregistrations-invoice',$data->id)}}" target="_blank" class="btn btn-outline-primary fw-bold px-1 py-0">Invoice</a>
                          <a href="{{url('ieltsregistrations-print',$data->id)}}" target="_blank" class="btn btn-outline-primary fw-bold px-1 py-0">Print</a>
                          <a href="{{url('ieltsregistrations/'.$data->id.'/edit')}}" class="btn btn-outline-success fw-bold px-1 py-0">Edit</a>
                    ...
                    <div class="modal fade" id="Edit{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="{{url('ieltsregistrations/'.$data->id)}}" method="post" enctype="multipart/form-data" > @csrf @method('put')
                          <div class="modal-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label for="date">Date</label>
                    ...
                    <div class="modal fade" id="Delete{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="{{url('ieltsregistrations/'.$data->id)}}" method="post" enctype="multipart/form-data" > @csrf @method('delete')
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
