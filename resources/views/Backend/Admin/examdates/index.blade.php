...
<div class="container-fluid">
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 text-end">
            <a href="{{url('exam-date-delete')}}" class="btn btn-dark">Delete Previous Data</a>
    ...
    <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form action="{{url('examdates')}}" method="post" enctype="multipart/form-data" > @csrf
        ...
        <div class="col-12">
            ...
            <div class="table-responsive">
                <table class="table table-dark table-responsive table-hover table-striped">
                  ...
                  <tbody>
                    @foreach($examdates as $data)
                    <tr>
                      <th scope="row">{{$loop->index+1}}</th>
                      <td>{{$data->date}}</td>
                      <td>{{$data->title}}</td>
                      <td class="text-end text-nowrap">
                          <a href="{{url('examdate/'.$data->id.'/times')}}" class="btn btn-outline-primary fw-bold px-1 py-0">Time Schedule</a>
                    ...
                    <div class="modal fade" id="Edit{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="{{url('examdates/'.$data->id)}}" method="post" enctype="multipart/form-data" > @csrf @method('put')
                          <div class="modal-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label for="title">Title</label>
                    ...
                    <div class="modal fade" id="Delete{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="{{url('examdates/'.$data->id)}}" method="post" enctype="multipart/form-data" > @csrf @method('delete')
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
