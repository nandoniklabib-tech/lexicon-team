...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6 text-start fs-5">
            ...
            <a >Lexifly Countries for Higher Education</a>
        </div>
    ...
    <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form action="{{url('lexiflycountries')}}" method="post" enctype="multipart/form-data" > @csrf
          <input type="hidden" name="type" value="Higher Education">
                ...
                <table class="table table-dark table-responsive table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$data->name}}</td>
                      <td class="text-center"><img width="100px" height="70px" src="{{asset('images/lexiflycountries/'.$data->image)}}" alt="image"></td>
                      <td class="text-end text-nowrap">
                          <a href="{{url('lexifly-country-universities',$data->id)}}" class="btn btn-outline-primary fw-bold px-1 py-0">Universities</a>
                    ...
                    <div class="modal fade" id="Edit{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="{{url('lexiflycountries/'.$data->id)}}" method="post" enctype="multipart/form-data" > @csrf @method('put')
                          <div class="modal-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label for="name">name</label>
                                ...
                                <div class="col-12 mb-3">
                                    <label for="image">Image [ 3*2 ]</label>
                                    <img width="200px" height="140px" src="{{asset('images/lexiflycountries/'.$data->image)}}" alt="image">
                    ...
                    <div class="modal fade" id="Delete{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="{{url('lexiflycountries/'.$data->id)}}" method="post" enctype="multipart/form-data" > @csrf @method('delete')
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
