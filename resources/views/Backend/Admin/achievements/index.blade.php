    ...
    <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <form action="{{url('achievements')}}" method="post" enctype="multipart/form-data" > @csrf
          <div class="modal-body">
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    <label for="image">Image [ 7*3 ]</label>
                    <input type="file" name="image" id="image" class="form-control mt-2" required>
                </div>
                <div class="col-12 mb-3">
                    <label for="description">Description</label>
                    <textarea name="description" rows="5" cols="33" class="form-control mt-2" id="description">{{old('description')}}</textarea>
                </div>
            </div>
          </div>
                ...
                <table class="table table-dark table-responsive table-hover table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$data->title}}</td>
                      <td class="text-center"><img width="100px" height="70px" src="{{asset('images/achievements/'.$data->image)}}" alt="image"></td>
                    ...
                    <div class="modal fade" id="Edit{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="{{url('achievements/'.$data->id)}}" method="post" enctype="multipart/form-data" > @csrf @method('put')
                          <div class="modal-body">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label for="title">Title</label>
                                ...
                                <div class="col-12 mb-3">
                                    <label for="image">Image [ 7*3 ]</label>
                                    <img width="200px" height="140px" src="{{asset('images/achievements/'.$data->image)}}" alt="image">
                                    <input type="file" name="image" id="image" class="form-control mt-2">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="description">Description</label>
                                    <textarea name="description" rows="5" cols="33" class="form-control mt-2" id="description{{$data->id}}">{{$data->description}}</textarea>
                                </div>
                            </div>
                          </div>
                          <div class="modal-footer">
                    ...
                    <div class="modal fade" id="Delete{{$data->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form action="{{url('achievements/'.$data->id)}}" method="post" enctype="multipart/form-data" > @csrf @method('delete')
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
