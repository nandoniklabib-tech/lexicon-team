...
<div class="container-fluid">
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 text-end">
            <a href="{{url('mcqs-yle')}}" class="btn btn-outline-primary me-2">YLE</a>
            <a href="{{url('mcqs-esl')}}" class="btn btn-outline-primary me-2">ESL</a>
            <a href="{{url('mcqs-ielts')}}" class="btn btn-outline-primary me-2">IELTS</a>
          ...
          <div class="modal-body">
            <div class="row">
                <div class="col-12 mb-3">
                    ...
                    <select name="type" id="type" class="form-select mt-2" required>
