...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6 text-start fs-5">
            ...
            <a >MCQs (ESL - {{count($mcqs)}})</a>
        </div>
        <div class="col-md-6 text-end">
            <a href="{{url('mcqs-yle')}}" class="btn btn-outline-info me-2">YLE</a>
            <a href="{{url('mcqs-esl')}}" class="btn btn-info me-2">ESL</a>
            <a href="{{url('mcqs-ielts')}}" class="btn btn-outline-info me-2">IELTS</a>
    ...
    <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <input type="hidden" name="type" value="ESL">
