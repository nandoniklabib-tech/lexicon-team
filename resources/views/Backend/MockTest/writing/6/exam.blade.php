...
<div class="prev-next-div">
    ...
    <input type="hidden" name="exam" value="Writing Six">
                                     ...
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            <div>
                                                ...
                                                <p>The graphs below give information about computer ownership as a percentage of the population between 2002 and 2010, and by level of education for the years 2002 and 2010.</p>
                                                <p>Summarise the information by selecting and reporting the main features, and make comparisons where relevant.</p>
                                                <img class="img-fluid" src="{{asset('assets/documents/six1.png')}}" alt="image"> <br>
                                                <img class="img-fluid" src="{{asset('assets/documents/six2.png')}}" alt="image">
                                    ...
                                    <!-- QUESTIONS START  -->
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            ...
                                            <p>After you finish, use the checklist to evaluate your writing task. Then, compare your task with the sample answer.</p>
                                            <p>Write about the following topic: A person’s worth nowadays seems to be judged according to social status and material possessions. Old-fashioned values, such as honour, kindness and trust, no longer seem important.</p>
