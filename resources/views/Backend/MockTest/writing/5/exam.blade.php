...
<div class="prev-next-div">
    ...
    <input type="hidden" name="exam" value="Writing Five">
                                     ...
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            <div>
                                                ...
                                                <p>The graph below gives information about the sales of the three most commonly purchased items in a particular bakery for the year 2014.</p>
                                                <p>Summarise the information by selecting and reporting the main features, and make comparisons where relevant.</p>
                                                <img class="img-fluid" src="{{asset('assets/documents/five1.png')}}" alt="image">
                                    ...
                                    <!-- QUESTIONS START  -->
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            ...
                                            <p>After you finish, use the checklist to evaluate your writing task. Then, compare your task with the sample answer.</p>
                                            <p>Write about the following topic: The internet has changed the way we communicate. Much communication today happens through social media. Some people support this and think it is a positive development. Others believe that social media have negative effects.</p>
