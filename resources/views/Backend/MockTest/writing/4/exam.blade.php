...
<div class="prev-next-div">
    ...
    <input type="hidden" name="exam" value="Writing Four">
                                     ...
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            <div>
                                                ...
                                                <p>The chart below shows the average household spending pattern for households in three income categories as a proportion of their income.</p>
                                                <p>Summarise the information by selecting and reporting the main features, and make comparisons where relevant.</p>
                                                <img class="img-fluid" src="{{asset('assets/documents/four1.png')}}" alt="image">
                                    ...
                                    <!-- QUESTIONS START  -->
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            ...
                                            <p>After you finish, use the checklist to evaluate your writing task. Then, compare your task with the sample answer.</p>
                                            <p>Write about the following topic: Many major cities are facing a housing crisis as they cannot provide enough land for new buildings. Some local governments believe the problem could be solved by reassigning park land for residential development, because this land would be better used for housing.</p>
