...
<div class="prev-next-div">
    ...
    <input type="hidden" name="exam" value="Writing Two">
                                     ...
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            <div>
                                                ...
                                                <h4>You should spend about 20 minutes on this task.</h4>

                                                <p>The bar chart shows the percentage of adult male smokers in seven countries along with the world average in 2000 and 2015.</p>
                                                <p>Summarise the information by selecting and reporting the main features and make comparisons where relevant.</p>
                                                <p>Write at least 150 words.</p>
                                                <img class="img-fluid" src="{{asset('assets/documents/two1.png')}}" alt="image">
                                    ...
                                    <!-- QUESTIONS START  -->
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            ...
                                            <h4>You should spend about 40 minutes on this task.</h4>
                                            <p>Some people believe that governments should have access to people’s mobile phone call records and messages for safety reasons. Others believe that this information is private and should not be available without permission.</p>
                                            <p>Discuss both these views and give your opinion.</p>
