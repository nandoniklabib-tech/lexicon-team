...
<div class="prev-next-div">
    ...
    <input type="hidden" name="exam" value="Writing Three">
                                     ...
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            <div>
                                                ...
                                                <p>The chart below gives information about the production of grains, measured in million metric tons, from the years 2010 to 2015, with projections until 2030.</p>
                                                <p>Summarise the information by selecting and reporting the main features, and make comparisons where relevant.</p>
                                                <img class="img-fluid" src="{{asset('assets/documents/three1.png')}}" alt="image">
                                    ...
                                    <!-- QUESTIONS START  -->
                                     <div class="split-container">
                                        ...
                                        <div class="left-panel" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            ...
                                            <p>After you finish, use the checklist to evaluate your writing task. Then, compare your task with the sample answer.</p>
                                            <p>Write about the following topic: Unhealthy eating has a negative effect on both individuals and the society in which they live. Some people think that the government should tax unhealthy foods while others believe that a ‘fat tax’ is unfair and unnecessary.</p>
