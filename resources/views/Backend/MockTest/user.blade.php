    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                ...
                <form class="card bg-white p-4" action="{{ route('userInfoSave', $mockTest->id) }}" method="post"
                        ...
                        <div class="col-12 mb-3">
                            <label for="email" class="d-flex justify-content-between">
                                ...
                                <i class="bi bi-info-circle" data-bs-toggle="tooltip"
                                    title="Please provide a valid email address, as we will send your result to that email."></i>
                            </label>
