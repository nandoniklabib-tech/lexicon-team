...
<div class="prev-next-div">
    ...
    <form class="afterSubmitForm" action="{{url('admin-mocktest-writing-exam-store')}}" method="post"> @csrf
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-6" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            <div>
                                                ...
                                                <p>The diagram below shows how ethanol fuel is produced from corn.</p>
                                                <p>Summarise the information by selecting and reporting the main features and make comparisons where relevant.</p>
                                                <p>You should write at least 150 words.</p>

                                                <img class="img-fluid" src="{{asset('adminMock/1/2_0.jpg')}}" alt="image">
                                    ...
                                    <!-- QUESTIONS START  -->
                                     <div class="row">
                                        ...
                                        <div class="col-6" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            ...
                                            <p>Some people think that physical strength is important for success in sport, while other people think that mental strength is more important. Discuss both views and give your own opinion.</p>
