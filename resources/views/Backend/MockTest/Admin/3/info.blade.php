...
<div class="container py-5">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-6">
              ...
              <form class="card bg-white p-4" action="{{url('admin-mocktest-listening-info-store')}}" method="post" enctype="multipart/form-data" > @csrf
              <input type="hidden" name="mock_type" value="Admin3" >
                <div class="row">
