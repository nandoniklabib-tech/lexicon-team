                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-6" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            <div>
                                                ...
                                                <img class="img-fluid" src="{{asset('adminMock/1/g121.png')}}" alt="image">
                                    ...
                                    <!-- QUESTIONS START  -->
                                     <div class="row">
                                        ...
                                        <div class="col-6" style="height:66vh;overflow:auto; border-right:.5px solid gray;">
                                            ...
                                            <p>Some people believe that capital punishment should not be used. Others, however, argue that it should be allowed for the most serious crimes.</p>
