...
return new class extends Migration
{
    ...
    {
        Schema::create('ielts_registrations', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('guardian_passport_nid')->nullable();
            $table->string('guardian_passport_exp_date')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('ielts_registrations');
    }
};
